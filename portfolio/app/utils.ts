...
export const data =[
    {
      ...
      "description": "Worked on front-end and back-end at OpenTug, leading a significant codebase transition from jQuery to Solid.js. Redesigned and simplified numerous key web pages, improving frontend efficiency by over 30% and implementing a set of reusable Solid.js components.",
